...
from motogram.raw.core import TLObject
...
class RPCError(Exception):
    ...
    def __init__(
        ...
        super().__init__(f"Telegram saying: [{'-' if is_signed else ''}{self.CODE} {self.NAME}] - {self.MESSAGE.format(value=value)} {'(caused by "{rpc_name}")' if rpc_name else ''}")
